...
title: start
series: zkctl
commit: e5adf9eadb12e73f4384a6670682d19cc1c2fa3f
---
## zkctl start
...
```
      ...
      --config-path strings                                         Paths to search for config files in. (default [/private/tmp/website/vitessio.website/vitess])
